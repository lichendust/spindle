...
func _() {
	...
	_ = x[BRACE_CLOSE-39]
	_ = x[BRACKET_OPEN-40]
	_ = x[BRACKET_CLOSE-41]
	_ = x[ANGLE_OPEN-42]
	_ = x[ANGLE_CLOSE-43]
	_ = x[ESCAPE-44]
	_ = x[NUMBER-45]
	_ = x[FORWARD_SLASH-46]
	_ = x[MULTIPLY-47]
	_ = x[AMPERSAND-48]
	_ = x[COLON-49]
	_ = x[TILDE-50]
...
const _ast_type_name = "NULLBLANKRAWNORMALTOKENIMPORTPARTIALTEMPLATESCOPE_UNSETDECLDECL_BLOCKDECL_TOKENVARVAR_ENUMVAR_ANONCONTROL_FORCONTROL_IFOP_ANDOP_OROP_NOTRES_FINDERBLOCKis_formatterITALIC_OPENITALIC_CLOSEBOLD_OPENBOLD_CLOSEBOLD_ITALIC_OPENBOLD_ITALIC_CLOSEMARK_OPENMARK_CLOSESTRIKE_OPENSTRIKE_CLOSEis_lexerWHITESPACENEWLINEWORDIDENTBRACE_OPENBRACE_CLOSEBRACKET_OPENBRACKET_CLOSEANGLE_OPENANGLE_CLOSEESCAPENUMBERFORWARD_SLASHMULTIPLYAMPERSANDCOLONTILDEEOFis_non_wordNON_WORDASTERISKEQUALSBANGSTOPPLUSPERCENTPIPE"

var _ast_type_index = [...]uint16{0, 4, 9, 12, 18, 23, 29, 36, 44, 55, 59, 69, 79, 82, 90, 98, 109, 119, 125, 130, 136, 146, 151, 163, 174, 186, 195, 205, 221, 238, 247, 257, 268, 280, 288, 298, 305, 309, 314, 324, 335, 347, 360, 370, 381, 387, 393, 406, 414, 423, 428, 433, 436, 447, 455, 463, 469, 473, 477, 481, 488, 492}
